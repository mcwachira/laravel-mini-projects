        ...
        @csrf
            <div class="mb-4 grid grid-cols-2 gap-4">
                ...
                <div class="col-span-2">
                    <x-label for="salary" :required="true" type="number">
                       Salary
                    </x-label>
                ...
                <div>
                    ...
                    <x-radio-group name="category" :value="old('category')" :all-option="false"  :options="array_combine(array_map('ucfirst', \App\Models\Job::$category), \App\Models\Job::$category,)"/>
